...
import PersoMediaGrid from "../components/common/personMediaGrid";
...
const PersonDetails = () => {
  ...
  useEffect(() => {
    const getPerson = async () => {
      ...
      const { response, err } = await personApi.details({ personId });
  ...
  return (
    <>
      <Toolbar />
      {console.log("the value of personalID is:", person)}
      {person && (
        <>
          <Box sx={{ ...uiConfigs.style.mainContent }}>
            ...
            <Container header="medias">
              <PersoMediaGrid personId={personId} />
            </Container>
          </Box>
        </>
      )}
